...
CREATE TABLE `file_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文件资源表';

-- ----------------------------
-- Records of file_info
-- ----------------------------
INSERT INTO `file_info` VALUES ('7', 'http://localhost:4344/resource/9e6c18fe08fd435390676d8178bf550d.xml', 'settings', '9e6c18fe08fd435390676d8178bf550d.xml', 'xml', '0', '12606', 'xml', '2021-07-11 22:32:35', '0', '-1', 'local');
INSERT INTO `file_info` VALUES ('8', 'http://localhost:4344/resource/7f29368f271b4aff95609bff25e76f93.gif', 'logo', '7f29368f271b4aff95609bff25e76f93.gif', 'gif', '1', '33189', 'gif', '2021-07-11 22:44:17', '0', '-1', 'local');
...
CREATE TABLE `sys_role_auth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色权限关联表';
